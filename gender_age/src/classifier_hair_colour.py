...
from gender_age.src.helpers.print_info_hair_colour import print_info
from gender_age.src.helpers.print_statistics_hair_colour import print_statistics
from gender_age.src.make_gens_hair_colour import make_gens
from gender_age.src.plots.confusion_matrix_hair import confusion_matrix_hair
from gender_age.src.plots.plot_training_samples_hair_colour import show_training_samples
...
def classifier_hair_colour(save_dir,
    ...
    confusion_matrix_hair(test_gen.y, preds)
